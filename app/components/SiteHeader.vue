<template>
    <header class="sticky top-0 z-50 w-full bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shadow-sm">
        <div class="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
            ...
            <div class="hidden md:flex flex-1 justify-center max-w-xl px-4 relative">
                <input
                    ...
                    type="search"
                    placeholder="搜尋動漫..."
                    class="w-full bg-gray-100 dark:bg-gray-700 rounded-full px-4 py-2 pr-10 text-sm text-gray-800 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-indigo-400 outline-none"
                />
                <!-- Loading Spinner -->
                ...
                <transition name="dropdown">
                    <div
                        v-if="(searchResults.length || searchHistory.length) && showDropdown"
                        class="absolute top-full mt-2 w-full bg-white dark:bg-gray-800 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 z-50 max-h-96 overflow-y-auto"
                    >
                        ...
                        <div v-if="!searchQuery && searchHistory.length" class="py-2">
                            ...
                            <ul>
                                <li
                                    ...
                                    :key="i"
                                    class="px-4 py-2 hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer transition-colors flex items-center justify-between group"
                                ...
                                >
                                    ...
                                    <button
                                        @mousedown.prevent.stop="removeFromHistory(i)"
        ...
        <transition name="fade">
            <div v-if="mobileSearchOpen" class="md:hidden fixed inset-0 bg-white dark:bg-gray-800 flex flex-col px-4 py-3 z-[60]">
                <div class="flex items-center relative">
                    <input
                        ...
                        type="search"
                        placeholder="搜尋動漫..."
                        class="flex-1 bg-gray-100 dark:bg-gray-700 rounded-full px-4 py-2 pr-10 text-sm text-gray-800 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-indigo-400 outline-none"
                    />
                ...
                <div v-if="!searchQuery && searchHistory.length" class="mt-3 bg-white dark:bg-gray-800 rounded-xl overflow-y-auto flex-1">
                    ...
                    <ul>
                        ...
                        >
                            ...
                            <button
                                @click.stop="removeFromHistory(i)"
                                class="opacity-0 group-hover:opacity-100 transition-opacity p-1 hover:bg-gray-200 dark:hover:bg-gray-600 rounded"
                            >
                                <span class="material-icons text-gray-500 text-sm">close</span>
                            </button>
