...
<template>  
    <div class="max-w-7xl mx-auto px-4 py-6">
        ...
        <!-- Tabs -->
        <div class="bg-gray-950/5 dark:bg-white/10 rounded-lg shadow-sm mb-6">
            <div class="grid grid-cols-2 md:grid-cols-4 border-b border-gray-200 dark:border-gray-700">
                <button
                    ...
                    :class="[
                        'px-4 md:px-6 py-4 text-sm font-medium transition-colors relative',
                        activeTab === tab.id
                ...
                >
                    <span class="flex items-center justify-center gap-2">
                        ...
                        <span
                            ...
                            :class="['ml-1 px-2 py-0.5 text-xs rounded-full', tab.badgeColor]"
                        >
                            {{ tab.badge }}
                        </span>
                    </span>
                    <div
                        ...
                        class="absolute bottom-0 left-0 right-0 h-0.5 bg-gray-900 dark:bg-gray-100"
                    ></div>
                </button>
            </div>
        </div>
                    ...
                    <div v-for="request in incomingRequests" :key="request.id" class="bg-gray-950/5 dark:bg-white/10 rounded-lg shadow-sm p-4">
                        <div class="flex items-center gap-4">
                            ...
                            <div class="flex gap-2">
                                <button @click="handleAcceptRequest(request.id)" class="px-4 py-2 bg-gray-900 dark:bg-gray-100 hover:bg-gray-800 dark:hover:bg-gray-200 text-white dark:text-gray-900 text-sm font-medium rounded-lg transition-colors">接受</button>
                                <button @click="handleRejectRequest(request.id)" class="px-4 py-2 bg-white dark:bg-white/10 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 text-sm font-medium rounded-lg transition-colors">拒絕</button>
                            </div>
                        </div>
                    </div>
                </div>
